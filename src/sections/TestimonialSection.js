...
const TestimonialSection = () => {
  ...
  return (
    <section className="px-2 md:px-6 py-12 md:py-24">
        <div className='flex m-2 md:m-0 flex-col md:px-52 md:items-center justify-center h-full'>
        <p className='uppercase text-kimiBlue raleway text-xs md:text-sm font-medium tracking-widest mb-1'>Testimonials</p>
        <h2 className='text-xl md:text-4xl font-semibold montserrat mb-2 md:w-1/2 md:text-center'>From our customers to you:</h2>
        <p className='raleway text-sm leading-loose md:text-base font-medium md:w-5/6 md:text-center mb-5'>Real stories, real satisfaction. Discover why they choose us for quality and reliability for their needs.</p>
        </div>
      <div className="container max-w-xl mx-auto shadow-lg rounded-lg transition-transform duration-500 transform">
        <div className="flex flex-col items-center w-full p-6 space-y-8 rounded-md lg:h-full lg:p-8 dark:bg-gray-50 dark:text-gray-800">
          ...
          <blockquote className="max-w-lg md:text-lg italic font-medium text-center font-raleway">
            "{testimonials[currentIndex].quote}"
          </blockquote>
          <div className="text-center text-sm md:text-base dark:text-gray-600 font-montserrat">
