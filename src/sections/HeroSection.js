    ...
    return (
        <div>
            <div className='flex flex-col items-center mt-10 mb-5'>
                ...
                <h1 className='text-6xl font-extrabold montserrat mb-2 w-1/2 text-center'>Your leading PRSP platform</h1>
                ...
                <div className='flex justify-center mb-2'>
                    ...
                    <div className='flex justify-center items-center parent raleway'>
                        <p className='mr-2 underline-animation font-medium'>Learn More</p>
                        <svg 
