...
const StandardSection = () => {
    return ( 
        <div className="bg-kimiGray py-10">
            <div className='flex flex-col md:items-center mx-4 md:mb-5'>
                <p className='uppercase text-kimiBlue raleway text-xs md:text-sm font-medium tracking-widest mb-1'>Setting us apart</p>
                <h2 className='text-2xl md:text-4xl font-semibold montserrat mb-2 md:w-1/2 md:text-center'>Setting the standard</h2>
                <p className='raleway font-medium md:w-3/5 md:text-center md:text-base text-sm md:m-2 leading-loose'>Discover the ultimate messaging solution with Kimipay. Our leading platform offers a diverse range of services, including bulk SMS, USSD, IVR, and more. </p>
                <div className='grid md:grid-cols-2 mb-2 md:shadow-md items-center rounded-lg md:w-5/6 md:bg-white'>
                    ...
                    <div className="col p-1 md:h-4/5 overflow-y-scroll no-scrollbar md:pr-12">
                        <div className="row flex mt-3">
                            <div className="col flex flex-col items-center mr-8">
                                ...
                                <div className="h-12 md:h-16 w-1.5 md:w-2.5 mt-2 bg-kimiBlue rounded-full"></div>
                            </div>
                            <div className="col flex flex-col justify-center">
                                <h3 className="montserrat text-lg md:text-2xl font-bold ">Versatile Premium Rate Services</h3>
                        ...
                        <div className="row flex mt-3">
                            ...
                            <div className="col flex flex-col justify-center">
                                <h3 className="montserrat text-lg md:text-2xl font-bold ">Direct Network Connectivity</h3>
                        ...
                        <div className="row flex mt-3">
                            ...
                            <div className="col flex flex-col justify-center">
                                <h3 className="montserrat text-lg md:text-2xl font-bold ">Interactive USSD Engagement</h3>
                        ...
                        <div className="row flex mt-3">
                            ...
                            <div className="col flex flex-col justify-center">
                                <h3 className="montserrat text-lg md:text-2xl font-bold ">Targeted Audience Reach</h3>
                        ...
                        <div className="row flex mt-3">
                            ...
                            <div className="col flex flex-col justify-center">
                                <h3 className="montserrat text-lg md:text-2xl font-bold ">Scalable Platform</h3>
