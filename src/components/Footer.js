...
const Footer = () => {
    return ( 
        <footer className="px-4 divide-y dark:bg-kimiGray dark:text-gray-800">
                ...
                <div className="grid md:grid-cols-3 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                    <div className="space-y-3">
                        ...
                        <ul className="space-y-1 raleway font-medium">
                            <li>
                                <a rel="noopener noreferrer" href="#">Bulk SMS</a>
                            </li>
                            <li>
                                <a rel="noopener noreferrer" href="#">USSD</a>
                            </li>
                            <li>
                                <a rel="noopener noreferrer" href="#">SMS Shortcodes</a>
                            </li>
                            <li>
                                <a rel="noopener noreferrer" href="#">RBT and Skiza Tunes</a>
                            </li>
                        </ul>
                    </div>
                    <div className="space-y-3">
                        <h3 className="tracking-wide montserrat font-bold uppercase text-lg dark:text-gray-900">Company</h3>
                        <ul className="space-y-1">
                            <li>
                                <a rel="noopener noreferrer" href="https://kimipay.com">kimipay.com</a>
                            </li>
                        </ul>
                    </div>
                    <div className="space-y-3 w-full">
                        <h3 className="montserrat font-bold uppercase text-lg dark:text-gray-900">Newsletter</h3>
                        <p className="raleway font-medium">Stay up to date with all things Kimipay</p>
                ...
                <div className="uppercase font-extrabold montserrat dark:text-gray-900 text-sm md:text-base mr-4">Follow us</div>
                    <div className="flex justify-start space-x-3">
                        ...
                        <a rel="noopener noreferrer" href="#" title="Twitter" className="flex items-center p-1">
                            <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#1DA1F2" className="w-5 h-5 fill-#1DA1F2">
                                <path d="M23.954 4.569a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.691 8.094 4.066 6.13 1.64 3.161a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.061a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.937 4.937 0 004.604 3.417 9.868 9.868 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.054 0 13.999-7.496 13.999-13.986 0-.209 0-.42-.015-.63a9.936 9.936 0 002.46-2.548l-.047-.02z"></path>
                            </svg>
                        </a>
                        <a rel="noopener noreferrer" href="#" title="Instagram" className="flex items-center p-1">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" fill="#C13584" className="w-5 h-5 fill-#C13584">
            ...
            <div className="py-6 text-sm text-center dark:text-gray-600">© 2024 Kimipay Ltd. All rights reserved.</div>
        </footer>
     );
}
